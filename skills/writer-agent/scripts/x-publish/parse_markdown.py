...
def find_image_file(original_path: str, filename: str) -> tuple[str, bool]:
    """Resolve an image only at the path declared by the Markdown source.
    
    Args:
        original_path: The resolved absolute path from markdown
        filename: Retained for the parser's stable call contract.
    ...
    del filename
    print(f"[parse_markdown] WARNING: Image not found: '{original_path}'", file=sys.stderr)
