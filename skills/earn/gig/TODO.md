...
0. **Existing funded liabilities first.** Finish every already-purchased Coconala/CrowdWorks obligation
   ...
   replay-zero. It does not wait for 逃げ因子 or any other client. Manledge/Clover `18169985` is closed
   and excluded.
