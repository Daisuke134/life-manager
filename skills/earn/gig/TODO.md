...
- [x] Kokoro `18250352`: processed independently with its own verified v12 submission; replay zero unless a newer
  buyer event appears.
- [ ] Chii `18180857`: current official Sheet truth is 133/300 unique TikTok-send plus Sheet rows, 167 remaining
  (read back from `2026年8月!A1:B400` on 2026-09-15; ordered handle digest
  `6cae3f0befa8608b3530312040da866cc457a5baca289626aee78705d80a7b8b`). Continue with existing tools only,
