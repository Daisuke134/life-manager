...
- Paid: owns funded work, requirements, production, QA, delivery, payment, provider settlement, and bank reconciliation. The current boundary implements complete official inventory/detail readback, contract-specific answer composition, independent quality verification, quality-digest effect fencing, and replay-safe message/readback handling; formal delivery, payment, provider settlement, and bank reconciliation remain gated until a real funded contract exposes their official surfaces.
