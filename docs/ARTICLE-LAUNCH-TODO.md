...
3. **host capacity**: floorは`1,155,780,608` bytes、今回のfree readbackは`425,041,920` bytes。floor未達ならgeneration前にfail-closedする。
...
7. **resume fence**: `article-resume`に過去occurrenceに加え、最新run `18d6a5a6b607fd90-19669`の`effect_unknown` claimが残る。
