...
assert len(manifest["worker_plist_cutover"]["labels"]) == len(set(manifest["worker_plist_cutover"]["labels"]))
print("registry_manifest_drift=missing-repair-candidate-label")
PY
~~~
