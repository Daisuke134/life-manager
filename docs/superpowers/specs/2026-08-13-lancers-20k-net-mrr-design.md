...
**Live checkpoint (2026-09-18 02:36 UTC).** This supersedes the older counts below; the L-08
cursor and L-09 onward order stay in place. `contracts.json` is source-complete as of
`02:35:44 UTC`: incoming monthly offers 0, monthly contracts 0, received gross JPY 0.
