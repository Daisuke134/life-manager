...
**Live checkpoint (2026-09-18 03:40 UTC).** This supersedes the older counts below; the L-08
cursor and L-09 onward order stay in place. `contracts.json` is source-complete as of
`03:39:23 UTC`: incoming monthly offers 0, monthly contracts 0, received gross JPY 0.
