...
**Current Connector cursor (read-only state, 2026-09-18):** **NOT DONE.** The active native route is Luma/Connpass only, with the existing 1800-second interval. Connector-owned fixes are merged through PRs #5514, #5517, #5521, #5527, #5530, #5532 and #5534; the latest main SHA is `8dc1403d5ac22c0e9de7e4a34cf7404fb3d542a3`, and the Connector label is loaded from `/Users/anicca/loops/releases/20260918T103548-8dc1403d` with the same SHA. The focused Connector tests and `bin/lm-loop-contract` pass; CI's only recorded failure remains the unrelated `manifest_inventory_mismatch skills/_shared` check.
