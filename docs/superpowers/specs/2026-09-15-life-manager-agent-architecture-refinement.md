...
1. Shared release owner: produce a complete main-derived release containing `apps/life-manager/node_modules/{playwright-core,jsqr}`; current `c619ed36` is rejected by Connector reconcile. Do not repair the immutable release or cut it from the Connector worktree.
