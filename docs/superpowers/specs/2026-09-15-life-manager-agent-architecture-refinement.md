...
### Atomic remaining execution list — current cursor A12e3
...
- [ ] A12e3 — After Connector PID 16133 reaches terminal, atomically advance `current` to `454fc8bb` and exact-load Connector only while idle; do not interrupt its browser/session.
