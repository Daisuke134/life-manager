...
1. Run one natural/approved Connector wake on loaded `f2b2550b` after the terminal above; reach a genuinely free/open Connpass event or a Luma event with `calendar_free>0`.
