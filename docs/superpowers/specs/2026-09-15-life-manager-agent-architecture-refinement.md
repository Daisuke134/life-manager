...
1. Finish Affiliate without manual restart: PartnerStack authentication/link readback, exact occurrence
   ...
   loaded-idle on that exact SHA. Require one natural wake with authenticated provider/service/network
   state, exact-link dedupe, no
