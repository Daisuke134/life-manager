...
**Current Connector cursor (read-only state, 2026-09-19):** **REPLAY GATE OPEN.** The active native route is Luma/Connpass only, with the existing 1800-second interval; X is not a Connector provider or fallback. Connector-owned fixes are merged through PRs #5514, #5517, #5521, #5527, #5530, #5532, #5534, #5548 and #5559. The Connector label is now installed on complete main-derived release `/Users/anicca/loops/releases/20260919T000834-0c1d82ea`, SHA `0c1d82ea09d6ce86baad34aaee0f852439e022a0`; the current installed SHA is aligned, while the event SHA remains from the last blocked terminal. The next occurrence was deferred before provider work with `host_admission_deferred:resource_control_busy`; no provider retry is authorized while that queue state is unresolved. The last provider-reaching wake `wake-61848e3003edbc88d323e912` on the previous complete SHA ended `completed_no_effect/providers_exhausted` with Submit 0, effect_unknown 0, paid/restricted Connpass candidates and no Calendar-free Luma candidate. The focused Connector tests pass; CI's recorded failures remain unrelated `skills/_shared` inventory mismatch and main-owned registry fixture drift.
...
1. Observe the next scheduled natural Connector wake so the event SHA updates from the prior `resource_control_busy` terminal to installed/current `0c1d82ea`; the latest occurrence `life-manager-connector-native:18d66ffb90141af0-25005` is already `released/effect_unknown=0`. Do not hand-kick another wake, stop siblings, or edit the DB.
