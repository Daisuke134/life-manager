...
| 11 | `BROWSER-04` shared Lancers browser session leaseをmain由来releaseへ反映 | Lancers browser boundary + all Lancers owners | **branch `4f0e4713ed` code/tests PASS**: 2 client同時取得を拒否し、lease解放後に再取得できる。main merge後、Application/Paid/Reply/Storefrontの2 natural wakeで競合0を確認 |
