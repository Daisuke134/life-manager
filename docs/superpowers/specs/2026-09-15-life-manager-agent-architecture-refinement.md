...
- CC01 implementation plan: `docs/superpowers/plans/2026-09-22-life-manager-owned-goal-policy.md`. The plan is source/contract-only, preserves integration consent as distinct from goal authorship, and excludes every J7 Paid resource. CC01 remains open until its focused tests and contract gate pass on pushed commits.
