...
**Current Connector cursor (read-only state, 2026-09-18):** **REPLAY GATE OPEN.** The active native route is Luma/Connpass only, with the existing 1800-second interval. Connector-owned fixes are merged through PRs #5514, #5517, #5521, #5527, #5530, #5532, #5534, #5548 and #5559; the login-wall fix is loaded in `/Users/anicca/loops/releases/20260918T143027-91f478bf` with SHA `91f478bf82270d97f65714d90f87e32ae44dc32c`. Main has advanced to `a3b8421424`; the original effect run loaded `/Users/anicca/loops/releases/20260918T120510-919e3484` with SHA `919e3484202147094c33b5874399b00fba09dd2c`. The focused Connector tests pass; CI's recorded failures remain unrelated `skills/_shared` inventory mismatch and main-owned registry fixture drift.
