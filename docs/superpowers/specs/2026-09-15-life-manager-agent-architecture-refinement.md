...
**Current Connector cursor (read-only state, 2026-09-19):** **REPLAY GATE OPEN.** The active native route is Luma/Connpass only, with the existing 1800-second interval; X is not a Connector provider or fallback. Connector-owned fixes are merged through PRs #5514, #5517, #5521, #5527, #5530, #5532, #5534, #5548 and #5559. The Connector label is installed on complete main-derived release `/Users/anicca/loops/releases/20260919T000834-0c1d82ea`, SHA `0c1d82ea09d6ce86baad34aaee0f852439e022a0`; installed SHA and event SHA now agree. The latest natural wake `wake-fead1bf2cb6cfea26eba4062` reached `completed_no_effect/providers_exhausted` on that SHA with Submit 0, effect_unknown 0, paid/restricted Connpass candidates and no Calendar-free Luma candidate. The earlier `resource_capacity_busy` occurrence was later claimed and released known. The focused Connector tests pass; CI's recorded failures remain unrelated `skills/_shared` inventory mismatch and main-owned registry fixture drift.
