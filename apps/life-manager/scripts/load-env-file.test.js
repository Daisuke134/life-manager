...
test("the shared mobile app command loads the private marketing env", () => {
  const source = fs.readFileSync(path.join(__dirname, "mobile-app"), "utf8");
  assert.ok(source.includes("lib/load-env-file.sh"));
