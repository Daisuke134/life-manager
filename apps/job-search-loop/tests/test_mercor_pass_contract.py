...
class MercorPassContractTests(unittest.TestCase):
    ...
    def test_prompt_contains_model_led_submit_guard_and_human_stop(self):
        ...
        for required in (
            ...
            "operational live-action ceiling is 600 seconds or eight opened detail pages",
            "At that ceiling, stop all browser commands",
            "parent will merge the current-run card-only artifact",
